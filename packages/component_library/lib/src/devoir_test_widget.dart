...
class DevoirTestWidget extends StatefulWidget {
  DevoirTestWidget({super.key, required this.args, this.presentationMode});
...
class _DevoirTestWidgetState extends State<DevoirTestWidget> {
  ...
  void didChangeDependencies() async {
    if (widget.presentationMode == false)
    {
      if (_isInit)
      {
        _isLoading = true;
    ...
    return Padding(
      ...
      child: Column(mainAxisAlignment: MainAxisAlignment.spaceAround, crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        ListOfWidget(
          ...
          additionDialog: widget.presentationMode == true ? null : additionDialog(CardState.Devoir),
        ...
        ListOfWidget(
          ...
          additionDialog: widget.presentationMode == true ? null : additionDialog(CardState.Test),
          type: CardState.Test,
        )
      ]),
    );
