...
class _EleveCardWidgetState extends State<EleveCardWidget> {
  Color changeColors(){
    return widget.eleve.id == EleveGestionFormGlobal.cp ?const Color.fromARGB(255, 255, 134, 134) : const Color.fromARGB(255, 199, 199, 199);
  }
        ...
        child: Column(children: [
          Column(
            ...
            children: [
              Container(),
              IconButton(
                onPressed: widget.presentationMode.isNull || widget.presentationMode! == true ? (){} : (){
                  showDialog(
                    context: context,
